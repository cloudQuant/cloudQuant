...
- [`backtrader`](https://github.com/cloudQuant/backtrader) — 量化交易回测与实盘框架
- [`backtrader_web`](https://github.com/cloudQuant/backtrader_web) — 基于 Web 的 Backtrader 全流程管理工具
- [`bt_api_py`](https://github.com/cloudQuant/bt_api_py) — 多交易所标准化接口 Python SDK
- [`pymt5`](https://github.com/cloudQuant/pymt5) — MT5 Web Terminal Python 客户端
- [`fincore`](https://github.com/cloudQuant/fincore) — 金融指标、分析与量化流程统一工具包

### 研究与分析

- [`alphalens`](https://github.com/cloudQuant/alphalens) — 因子与 Alpha 分析
- [`pyfolio`](https://github.com/cloudQuant/pyfolio) — 组合与风险分析
- [`empyrical`](https://github.com/cloudQuant/empyrical) — 金融绩效指标库

### 数据、接口与生态工具

- [`akshare_web`](https://github.com/cloudQuant/akshare_web) — Akshare 相关工作流与管理工具
- [`ctp-python`](https://github.com/cloudQuant/ctp-python) — Python CTP 期货接口
- [`openclaw`](https://github.com/cloudQuant/openclaw) — AI 助手相关工具
